...
import {MapMarker, useMap, Map} from 'react-kakao-maps-sdk'
import {useState} from 'react'

const App2 = () => {
    //지도의 중심좌표를 나타낼 state들
   ...
   const [level,setLevel]=useState(3)
    ...
    const [data,setData] =useState ([
        ...
        {
          content: <div style={{ color: "#000" }}>스마트 인재 개발원</div>,
      ...
      const smhrdMarker=()=>{
        console.log('smhrd Marker ');
        setCenterLat(35.149915)
        setCenterLon(126.919861)
        setData([
             {
  ...
  return (
    ...
    <button onClick={smhrdMarker}>스마트인재 개발원 </button>
